...
export default function AllProducts() {
  ...
  return (
    <div className="container mx-auto py-5">
      <div className="px-2">
        <div className="relative w-full max-w-xl mx-auto bg-[#F3F3F3] rounded-md my-5">
          <input
            type="text"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            placeholder="Search products..."
            className="w-full pl-4 pr-10 py-2    rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#FF9900] focus:border-transparent text-gray-700 placeholder-gray-400"
          />
          <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 z-10">
            <i className="fa-solid fa-magnifying-glass"></i>
          </span>
          <span className="absolute top-0 bottom-0 right-0  w-12 bg-amber-300 rounded-e-md "></span>
        </div>
      </div>
